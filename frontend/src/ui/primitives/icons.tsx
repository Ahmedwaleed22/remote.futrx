...
export const FolderOpen = (p: P) => (
  <svg {...base} {...p}>
    <path d="m6 14 1.45-2.9A2 2 0 0 1 9.24 10H21a2 2 0 0 1 1.94 2.5l-1.55 6A2 2 0 0 1 19.5 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.93a2 2 0 0 1 1.66.9l.82 1.2a2 2 0 0 0 1.66.9H18a2 2 0 0 1 2 2v2" />
  </svg>
);
...
export const ChevronsUpDown = (p: P) => (
  <svg {...base} {...p}>
    <path d="M7 9l5-5 5 5M7 15l5 5 5-5" />
  </svg>
);
export const ChevronsDownUp = (p: P) => (
  <svg {...base} {...p}>
...
export const CalendarClock = (p: P) => (
  <svg {...base} {...p}>
    <path d="M8 2v4M16 2v4M3 10h18M5 4h14a2 2 0 0 1 2 2v5M12 21H5a2 2 0 0 1-2-2V6" />
...
export const EyeOff = (p: P) => (
  <svg {...base} {...p}>
    <path d="M17.94 17.94A10.43 10.43 0 0 1 12 19c-6 0-10-7-10-7a18.5 18.5 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c6 0 10 7 10 7a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24" />
    <path d="m1 1 22 22" />
  </svg>
);
...
export const Bot = (p: P) => (
  <svg {...base} {...p}>
    ...
    <path d="M12 2v4M8 11h.01M16 11h.01M9 15h6M2 10h2M20 10h2" />
  </svg>
);
...
export const MemoryStick = (p: P) => (
  <svg {...base} {...p}>
    <rect x="2" y="6" width="20" height="12" rx="2" />
    <path d="M6 10h2v4H6zM11 10h2v4h-2zM16 10h2v4h-2zM6 18v2M10 18v2M14 18v2M18 18v2" />
  </svg>
);
export const HardDrive = (p: P) => (
  <svg {...base} {...p}>
    <path d="M22 12H2l3-7h14l3 7Z" />
    <rect x="2" y="12" width="20" height="7" rx="1" />
    <path d="M6 15.5h.01M10 15.5h.01" />
  </svg>
);
