      ...
      class={`text-left rounded-md border px-3 py-2.5 min-h-12 transition-colors
              ${
                active
                  ...
                  : "border-white/10 border-dashed bg-white/[0.03] hover:bg-white/[0.07]"
              } sm:col-span-2`}
    >
      <div class="flex items-start gap-2">
        <div
          class={`flex-none mt-0.5 w-4 h-4 ${multi ? "rounded-sm" : "rounded-full"}
        ...
        <div class="flex-1 min-w-0">
          <div
            class={`text-[13px] font-medium ${active ? "text-accent-blue" : "text-ink-200"}`}
          >
